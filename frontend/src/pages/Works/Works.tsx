    ...
    <WorkWrapper isLoading={!worksArr}>
        ...
        <div className="work_container">
          <div className="work_header">
            ...
            <WorkFilterSelectWrapper  isSelected={filterPayload.platform !=="All" } name="platform" id="" onChange={handleFilterSelectChange}>
            ...
            <WorkFilterSelectWrapper isSelected={filterPayload.status !=="All"} name="status" id="" onChange={handleFilterSelectChange}>
              <option value="All">All</option>
            ...
            <WorkFilterSelectWrapper isSelected={filterPayload.rating !== "All"} name="rating" id="" onChange={handleFilterSelectChange}>
              <option value="All">All</option>
